...
export const ftCmdID = {
  ...
  QotGetBasicQot: {
    cmd: 3004,
    name: "Qot_GetBasicQot",
    description: "获取基本行情",
  } /**< 获取基本行情 */,
  QotUpdateBasicQot: {
    cmd: 3005,
    name: "Qot_UpdateBasicQot",
    description: "推送基本行情",
  } /**< 推送基本行情 */,
  QotGetKL: {
    cmd: 3006,
  ...
  QotUpdateTicker: {
    cmd: 3011,
    name: "Qot_UpdateTicker",
    description: "推送逐笔",
  } /**< 推送逐笔 */,
  QotGetOrderBook: {
    cmd: 3012,
    name: "Qot_GetOrderBook",
    description: "获取买卖盘",
  } /**< 获取买卖盘 */,
  QotUpdateOrderBook: {
    cmd: 3013,
    name: "Qot_UpdateOrderBook",
    description: "推送买卖盘",
  } /**< 推送买卖盘 */,
  QotGetBroker: {
    cmd: 3014,
  ...
  QotGetPlateSet: {
    cmd: 3204,
    name: "Qot_GetPlateSet",
    description: "获取板块集合下的板块",
  } /**< 获取板块集合下的板块 */,
  QotGetPlateSecurity: {
    cmd: 3205,
    name: "Qot_GetPlateSecurity",
  ...
  QotStockFilter: {
    cmd: 3215,
    name: "Qot_StockFilter",
    description: "条件选股",
  } /**< 条件选股 */,
  QotGetCodeChange: {
    cmd: 3216,
    name: "Qot_GetCodeChange",
  ...
  QotRequestTradeDate: {
    cmd: 3219,
    name: "Qot_RequestTradeDate",
    description: "获取市场交易日",
  } /**< 获取市场交易日 */,
  QotSetPriceReminder: {
    cmd: 3220,
    name: "Qot_SetPriceReminder",
    description: "设置到价提醒",
  } /**< 设置到价提醒 */,
  QotGetPriceReminder: {
    cmd: 3221,
    name: "Qot_GetPriceReminder",
    description: "获取到价提醒",
  } /**< 获取到价提醒 */,
  ...
  TrdGetPositionList: {
    cmd: 2102,
    name: "Trd_GetPositionList",
    description: "获取账户持仓",
  } /**< 获取账户持仓 */,
  TrdGetMaxTrdQtys: {
    cmd: 2111,
    name: "Trd_GetMaxTrdQtys",
    description: "获取最大交易数量",
  } /**< 获取最大交易数量 */,
  TrdGetOrderList: {
    cmd: 2201,
    name: "Trd_GetOrderList",
    description: "获取订单列表",
  } /**< 获取订单列表 */,
  TrdPlaceOrder: {
    cmd: 2202,
  ...
  TrdModifyOrder: {
    cmd: 2205,
    name: "Trd_ModifyOrder",
    description: "修改订单",
  } /**< 修改订单 */,
  TrdUpdateOrder: {
    cmd: 2208,
    name: "Trd_UpdateOrder",
    description: "订单状态变动通知(推送)",
  } /**< 订单状态变动通知(推送) */,
  TrdGetOrderFillList: {
    cmd: 2211,
    name: "Trd_GetOrderFillList",
    description: "获取成交列表",
  } /**< 获取成交列表 */,
  TrdUpdateOrderFill: {
    cmd: 2218,
    name: "Trd_UpdateOrderFill",
    description: "成交通知(推送)",
  } /**< 成交通知(推送) */,
...
class ftWebsocket {
  ...
  start(ip, port, ssl, key) {
    ...
    const InitWebSocketPBMessageRequest = protoRoot.lookup(
      "InitWebSocket.Request"
    ); // 请求体message
  ...
  GetAccList(req) {
    return this._sendCmd(
      ftCmdID.TrdGetAccList.cmd,
      req,
      ftCmdID.TrdGetAccList.name
    );
  }
  /**
  ...
  UnlockTrade(req) {
    return this._sendCmd(
      ftCmdID.TrdUnlockTrade.cmd,
      req,
      ftCmdID.TrdUnlockTrade.name
    );
  }
  /**
   * @brief 订阅接收推送数据的交易账户
  ...
  SubAccPush(req) {
    return this._sendCmd(
      ftCmdID.TrdSubAccPush.cmd,
      req,
      ftCmdID.TrdSubAccPush.name
    );
  }
  /**
   * @brief 获取账户资金
  ...
  GetFunds(req) {
    return this._sendCmd(
      ftCmdID.TrdGetFunds.cmd,
      req,
      ftCmdID.TrdGetFunds.name
    );
  }
  /**
   * @brief 获取账户持仓
  ...
  GetPositionList(req) {
    return this._sendCmd(
      ftCmdID.TrdGetPositionList.cmd,
      req,
      ftCmdID.TrdGetPositionList.name
    );
  }
  /**
   * @brief 获取最大交易数量
  ...
  GetMaxTrdQtys(req) {
    return this._sendCmd(
      ftCmdID.TrdGetMaxTrdQtys.cmd,
      req,
      ftCmdID.TrdGetMaxTrdQtys.name
    );
  }
  /**
   * @brief 获取当日订单列表
  ...
  GetOrderList(req) {
    return this._sendCmd(
      ftCmdID.TrdGetOrderList.cmd,
      req,
      ftCmdID.TrdGetOrderList.name
    );
  }
  /**
   * @brief 下单
  ...
  PlaceOrder(req) {
    return this._sendCmd(
      ftCmdID.TrdPlaceOrder.cmd,
      req,
      ftCmdID.TrdPlaceOrder.name
    );
  }
  /**
   * @brief 修改订单
  ...
  ModifyOrder(req) {
    return this._sendCmd(
      ftCmdID.TrdModifyOrder.cmd,
      req,
      ftCmdID.TrdModifyOrder.name
    );
  }
  /**
   * @brief 获取当日成交列表
  ...
  GetOrderFillList(req) {
    return this._sendCmd(
      ftCmdID.TrdGetOrderFillList.cmd,
      req,
      ftCmdID.TrdGetOrderFillList.name
    );
  }
  /**
   * @brief 获取历史订单列表
  ...
  GetHistoryOrderList(req) {
    return this._sendCmd(
      ftCmdID.TrdGetHistoryOrderList.cmd,
      req,
      ftCmdID.TrdGetHistoryOrderList.name
    );
  }
  /**
   * @brief 获取历史成交列表
  ...
  GetHistoryOrderFillList(req) {
    return this._sendCmd(
      ftCmdID.TrdGetHistoryOrderFillList.cmd,
      req,
      ftCmdID.TrdGetHistoryOrderFillList.name
    );
  }
  /**
   * @brief 获取融资融券数据
  ...
  GetMarginRatio(req) {
    return this._sendCmd(
      ftCmdID.TrdGetMarginRatio.cmd,
      req,
      ftCmdID.TrdGetMarginRatio.name
    );
  }
  ...
  GetGlobalState(req) {
    return this._sendCmd(
      ftCmdID.GetGlobalState.cmd,
      req,
      ftCmdID.GetGlobalState.name
    );
  }
  /**
   * @brief 注册推送
  ...
  RegQotPush(req) {
    return this._sendCmd(
      ftCmdID.QotRegQotPush.cmd,
      req,
      ftCmdID.QotRegQotPush.name
    );
  }
  /**
   * @brief 获取订阅信息
  ...
  GetSubInfo(req) {
    return this._sendCmd(
      ftCmdID.QotGetSubInfo.cmd,
      req,
      ftCmdID.QotGetSubInfo.name
    );
  }
  /**
   * @brief 获取逐笔
  ...
  GetTicker(req) {
    return this._sendCmd(
      ftCmdID.QotGetTicker.cmd,
      req,
      ftCmdID.QotGetTicker.name
    );
  }
  /**
   * @brief 获取报价
  ...
  GetBasicQot(req) {
    return this._sendCmd(
      ftCmdID.QotGetBasicQot.cmd,
      req,
      ftCmdID.QotGetBasicQot.name
    );
  }
  /**
   * @brief 获取摆盘
  ...
  GetOrderBook(req) {
    return this._sendCmd(
      ftCmdID.QotGetOrderBook.cmd,
      req,
      ftCmdID.QotGetOrderBook.name
    );
  }
  /**
   * @brief 获取K线
  ...
  GetBroker(req) {
    return this._sendCmd(
      ftCmdID.QotGetBroker.cmd,
      req,
      ftCmdID.QotGetBroker.name
    );
  }
  /**
  ...
  RequestRehab(req) {
    return this._sendCmd(
      ftCmdID.QotRequestRehab.cmd,
      req,
      ftCmdID.QotRequestRehab.name
    );
  }
  /**
  ...
  RequestHistoryKL(req) {
    return this._sendCmd(
      ftCmdID.QotRequestHistoryKL.cmd,
      req,
      ftCmdID.QotRequestHistoryKL.name
    );
  }
  /**
   * @brief 获取历史K线已经用掉的额度
  ...
  RequestHistoryKLQuota(req) {
    return this._sendCmd(
      ftCmdID.QotRequestHistoryKLQuota.cmd,
      req,
      ftCmdID.QotRequestHistoryKLQuota.name
    );
  }
  /**
   * @brief 获取交易日
  ...
  GetTradeDate(req) {
    return this._sendCmd(
      ftCmdID.QotGetTradeDate.cmd,
      req,
      ftCmdID.QotGetTradeDate.name
    );
  }
  /**
   * @brief 获取静态信息
  ...
  GetStaticInfo(req) {
    return this._sendCmd(
      ftCmdID.QotGetStaticInfo.cmd,
      req,
      ftCmdID.QotGetStaticInfo.name
    );
  }
  /**
   * @brief 获取股票快照
  ...
  GetSecuritySnapshot(req) {
    return this._sendCmd(
      ftCmdID.QotGetSecuritySnapshot.cmd,
      req,
      ftCmdID.QotGetSecuritySnapshot.name
    );
  }
  /**
   * @brief 获取板块集合下的板块
  ...
  GetPlateSet(req) {
    return this._sendCmd(
      ftCmdID.QotGetPlateSet.cmd,
      req,
      ftCmdID.QotGetPlateSet.name
    );
  }
  /**
   * @brief 获取板块下的股票
  ...
  GetPlateSecurity(req) {
    return this._sendCmd(
      ftCmdID.QotGetPlateSecurity.cmd,
      req,
      ftCmdID.QotGetPlateSecurity.name
    );
  }
  /**
   * @brief 获取相关股票
  ...
  GetReference(req) {
    return this._sendCmd(
      ftCmdID.QotGetReference.cmd,
      req,
      ftCmdID.QotGetReference.name
    );
  }
  /**
   * @brief 获取股票所属的板块
  ...
  GetOwnerPlate(req) {
    return this._sendCmd(
      ftCmdID.QotGetOwnerPlate.cmd,
      req,
      ftCmdID.QotGetOwnerPlate.name
    );
  }
  /**
   * @brief 获取大股东持股变化列表
  ...
  GetHoldingChangeList(req) {
    return this._sendCmd(
      ftCmdID.QotGetHoldingChangeList.cmd,
      req,
      ftCmdID.QotGetHoldingChangeList.name
    );
  }
  /**
   * @brief 筛选期权
  ...
  GetOptionChain(req) {
    return this._sendCmd(
      ftCmdID.QotGetOptionChain.cmd,
      req,
      ftCmdID.QotGetOptionChain.name
    );
  }
  /**
   * @brief 筛选窝轮
  ...
  GetWarrant(req) {
    return this._sendCmd(
      ftCmdID.QotGetWarrant.cmd,
      req,
      ftCmdID.QotGetWarrant.name
    );
  }
  /**
   * @brief 获取资金流向
  ...
  GetCapitalFlow(req) {
    return this._sendCmd(
      ftCmdID.QotGetCapitalFlow.cmd,
      req,
      ftCmdID.QotGetCapitalFlow.name
    );
  }
  /**
   * @brief 获取资金分布
  ...
  GetCapitalDistribution(req) {
    return this._sendCmd(
      ftCmdID.QotGetCapitalDistribution.cmd,
      req,
      ftCmdID.QotGetCapitalDistribution.name
    );
  }
  /**
   * @brief 获取自选股分组下的股票
  ...
  GetUserSecurity(req) {
    return this._sendCmd(
      ftCmdID.QotGetUserSecurity.cmd,
      req,
      ftCmdID.QotGetUserSecurity.name
    );
  }
  /**
   * @brief 修改自选股分组下的股票
  ...
  ModifyUserSecurity(req) {
    return this._sendCmd(
      ftCmdID.QotModifyUserSecurity.cmd,
      req,
      ftCmdID.QotModifyUserSecurity.name
    );
  }
  /**
   * @brief 条件选股
  ...
  StockFilter(req) {
    return this._sendCmd(
      ftCmdID.QotStockFilter.cmd,
      req,
      ftCmdID.QotStockFilter.name
    );
  }
  /**
   * @brief 获取股票代码变化信息
  ...
  GetCodeChange(req) {
    return this._sendCmd(
      ftCmdID.QotGetCodeChange.cmd,
      req,
      ftCmdID.QotGetCodeChange.name
    );
  }
  /**
   * @brief 新股IPO
  ...
  GetIpoList(req) {
    return this._sendCmd(
      ftCmdID.QotGetIpoList.cmd,
      req,
      ftCmdID.QotGetIpoList.name
    );
  }
  /**
   * @brief 期货合约资料
  ...
  GetFutureInfo(req) {
    return this._sendCmd(
      ftCmdID.QotGetFutureInfo.cmd,
      req,
      ftCmdID.QotGetFutureInfo.name
    );
  }
  /**
   * @brief 获取市场交易日
  ...
  RequestTradeDate(req) {
    return this._sendCmd(
      ftCmdID.QotRequestTradeDate.cmd,
      req,
      ftCmdID.QotRequestTradeDate.name
    );
  }
  /**
   * @brief 设置到价提醒
  ...
  SetPriceReminder(req) {
    return this._sendCmd(
      ftCmdID.QotSetPriceReminder.cmd,
      req,
      ftCmdID.QotSetPriceReminder.name
    );
  }
  /**
   * @brief 获取到价提醒
  ...
  GetPriceReminder(req) {
    return this._sendCmd(
      ftCmdID.QotGetPriceReminder.cmd,
      req,
      ftCmdID.QotGetPriceReminder.name
    );
  }
  /**
   * @brief 获取自选股分组列表
  ...
  GetUserSecurityGroup(req) {
    return this._sendCmd(
      ftCmdID.QotGetUserSecurityGroup.cmd,
      req,
      ftCmdID.QotGetUserSecurityGroup.name
    );
  }
  /**
   * @brief 获取股票对应市场状态
  ...
  GetMarketState(req) {
    return this._sendCmd(
      ftCmdID.QotGetMarketState.cmd,
      req,
      ftCmdID.QotGetMarketState.name
    );
  }
  /**
   * @brief 获取期权链到期日
  ...
  GetOptionExpirationDate(req) {
    return this._sendCmd(
      ftCmdID.QotGetOptionExpirationDate.cmd,
      req,
      ftCmdID.QotGetOptionExpirationDate.name
    );
  }
  //=============================================
  /**
  ...
  _sendCmd(cmd, buff, name) {
    return new Promise((resolve, reject) => {
      ...
      let message = PBMessageRequest.encode(
        PBMessageRequest.create(buff)
      ).finish();
      this.websock
        .sendBuff(cmd, message)
        .then((response) => {
          if (response.buff) {
            const PBMessageResponse = protoRoot.lookup(name + ".Response"); // 回包message
            const buf = protobuf.util.newBuffer(response.buff);
            const ResponseObj = PBMessageResponse.decode(buf);
            if (
              ResponseObj.retType != null &&
      ...
      if (this.onPush && typeof this.onPush == "function") {
        if (response.error == 0 && response.buff) {
          ...
          if (obj != null && obj.name) {
            const NotifyPBMessageResponse = protoRoot.lookup(
              obj.name + ".Response"
            );
            const buf = protobuf.util.newBuffer(response.buff);
